...
inline double trace(const M33 &a) { return a.data[0] + a.data[4] + a.data[8]; }
...
inline M33 operator*(const M33 &A, double alpha) { return operator*(alpha, A); }
} // namespace math
